...
public interface SyncRequestClient {
	 ...
	 * 
	 * @param hedgeMode true for hedge; false for one-way/netting
	 * @return
	 */
	ResponseResult changePositionMode(boolean hedgeMode);

	/**
	 * Get user's position mode
	 * 
	 * @return true for hedge mode; false for one-way/netting mode.
	 */
	Boolean getPositionMode();
